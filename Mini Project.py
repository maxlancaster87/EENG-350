...
def userQuadrant():
    ...
    if (ImageLocationX > 256 and ImageLocationY <= 192):                     #Quadrant 1
        return 1

    if (ImageLocationX <=256 and ImageLocationY <= 192):                     #Quadrant 2
        return 2

    if (ImageLocationX <=256 and ImageLocationY > 192):                      #Quadrant 3
        return 3

    if (ImageLocationX > 256 and ImageLocationY > 192):                      #Quadrant 4
        return 4
...
#function that detects marker quadrant
def markerQuad():
